...
import { signInWithGooglePopup } from "../firebase/setup";
                  ...
                  <div className="flex flex-col gap-3 ">
                    ...
                    <div className="flex flex-col gap-3 items-center font-semibold">
                      <div className="border-2 border-primary rounded w-full">
                        <button className="flex gap-2 px-4 py-3 border-2 border-transparent  hover:border-primary w-full">
                          <Phone className="w-4" />
                          <span className="text-sm">Continue with phone</span>
                        </button>
                      </div>
                      <div className="border-2 border-[#d2e3fc] rounded w-full">
                        <button
                          onClick={logGoogleUser}
                          className="flex gap-2 px-4 py-2 border-2 border-transparent hover:border-[#d2e3fc] w-full bg-[#f8faff]"
                        >
